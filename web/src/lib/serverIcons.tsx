...
export const SERVER_ICONS: ServerIconDef[] = [
  ...
  { key: 'os-openwrt', label: 'OpenWrt / LEDE', Icon: simpleIcon(siOpenwrt) },
  { key: 'os-opnsense', label: 'OPNsense', Icon: simpleIcon(siOpnsense) },
  { key: 'os-pfsense', label: 'pfSense', Icon: simpleIcon(siPfsense) },
  { key: 'os-mikrotik', label: 'MikroTik RouterOS', Icon: simpleIcon(siMikrotik) },
  { key: 'os-vyos', label: 'VyOS', Icon: Router },
  { key: 'os-casaos', label: 'CasaOS', Icon: CasaOsIcon },
  { key: 'os-umbrel', label: 'Umbrel', Icon: simpleIcon(siUmbrel) },
  { key: 'os-yunohost', label: 'YunoHost', Icon: simpleIcon(siYunohost) },
  ...
  { key: 'os-popos', label: 'Pop!_OS', Icon: simpleIcon(siPopos) },
  { key: 'os-elementary', label: 'elementary OS', Icon: simpleIcon(siElementary) },
  { key: 'os-deepin', label: 'deepin', Icon: simpleIcon(siDeepin) },
  ...
  { key: 'os-endeavouros', label: 'EndeavourOS', Icon: simpleIcon(siEndeavouros) },
  { key: 'os-gentoo', label: 'Gentoo', Icon: simpleIcon(siGentoo) },
  { key: 'os-nixos', label: 'NixOS', Icon: simpleIcon(siNixos) },
  { key: 'os-voidlinux', label: 'Void Linux', Icon: simpleIcon(siVoidlinux) },
  { key: 'os-slackware', label: 'Slackware', Icon: simpleIcon(siSlackware) },
  ...
  { key: 'os-photon', label: 'VMware Photon OS', Icon: simpleIcon(siPhoton) },
  { key: 'os-freebsd', label: 'FreeBSD', Icon: simpleIcon(siFreebsd) },
  { key: 'os-openbsd', label: 'OpenBSD', Icon: simpleIcon(siOpenbsd) },
  { key: 'os-netbsd', label: 'NetBSD', Icon: simpleIcon(siNetbsd) },
  { key: 'os-macos', label: 'macOS', Icon: simpleIcon(siMacos) },
